 ...
 */
class OrderOption extends CActiveRecord
{
	/**
	...
	public function rules()
	{
		...
		return array(
			array('order_id, order_product_id, product_option_id, name, value, type', 'required'),
			...
			array('order_option_id, order_id, order_product_id, product_option_id, product_option_value_id, name, value, type', 'safe', 'on'=>'search'),
		);
	}
