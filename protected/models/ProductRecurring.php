 ...
 *
 * The followings are the available columns in table 'product_recurring':
 * @property integer $product_id
 * @property integer $store_id
 */
class ProductRecurring extends CActiveRecord
{
	/**
	 ...
	 * @return ProductRecurring the static model class
	 */
